...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const BrasilPage(), // Define a página inicial do app
    );
  }
}

class BrasilPage extends StatefulWidget {
...
class _SlideWithDotsState extends State<BrasilPage> {
              ...
              children: [
                ...
                Expanded(
                  child: PageView(
                    ...
                    children: [
                      slideImage('assets/imagens/brasil.png'),
                      slideImage('assets/imagens/brasil.png'),
                      slideImage('assets/imagens/brasil.png'),
                    ],
                  ),
