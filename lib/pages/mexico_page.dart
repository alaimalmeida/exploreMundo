...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MexicoPage(), // Define a página inicial do app
    );
  }
}

class MexicoPage extends StatefulWidget {
  const MexicoPage({super.key});

  @override
  _SlideWithDotsState createState() => _SlideWithDotsState();
}

class _SlideWithDotsState extends State<MexicoPage> {
              ...
              children: [
                ...
                Expanded(
                  child: PageView(
                    ...
                    children: [
                      slideImage('assets/imagens/mexico.png'),
                      slideImage('assets/imagens/mexico.png'),
                      slideImage('assets/imagens/mexico.png'),
                    ],
                  ),
