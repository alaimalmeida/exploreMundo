...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ChilePage(), // Define a página inicial do app
    );
  }
}

class ChilePage extends StatefulWidget {
  const ChilePage({super.key});

  @override
  _SlideWithDotsState createState() => _SlideWithDotsState();
}

class _SlideWithDotsState extends State<ChilePage> {
              ...
              children: [
                ...
                Expanded(
                  child: PageView(
                    ...
                    children: [
                      slideImage('assets/imagens/chile.png'),
                      slideImage('assets/imagens/chile.png'),
                      slideImage('assets/imagens/chile.png'),
                    ],
                  ),
