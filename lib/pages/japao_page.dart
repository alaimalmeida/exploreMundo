...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const JapaoPage(), // Define a página inicial do app
    );
  }
}

class JapaoPage extends StatefulWidget {
  const JapaoPage({super.key});

  @override
  _SlideWithDotsState createState() => _SlideWithDotsState();
}

class _SlideWithDotsState extends State<JapaoPage> {
              ...
              children: [
                ...
                Expanded(
                  child: PageView(
                    ...
                    children: [
                      slideImage('assets/imagens/japao.png'),
                      slideImage('assets/imagens/japao.png'),
                      slideImage('assets/imagens/japao.png'),
                    ],
                  ),
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  icon: Icon(
                    Icons.star,
                    color: _isStarred ? Colors.red : Colors.grey, // Alterna entre vermelho e sem cor
                  ),
                  onPressed: () {
                    setState(() {
